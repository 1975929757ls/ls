        ...
        <tr>
          ...
          <td>
            <el-form-item label="布料" >
              <el-select v-model="ruleForm.materials" placeholder="ruleForm.buliao"@change="changeprice">
...
<script>
    export default {
      ...
      created() {
        ...
        _this.$axios.get("http://localhost:8181/pattern/size").then(function (resp) {
          _this.size=resp.data
          console.log(resp.data)
        })
      }
    }
